...
//    fun getQueryBeginDateSortNewsDesk(@Query("q") query: String, @Query("begin_date") start_date: Int, @Query("sort") sort: String, @Query("fq") news_desk: String): Call<NewsArticle>
    ...
    @GET("articlesearch.json")
    fun getSearchDefault(@Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQuery(@Query("q") query: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQueryBeginDate(@Query("q") query: String, @Query("begin_date") start_date: Int, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQuerySort(@Query("q") query: String, @Query("sort") sort: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQueryBeginDateSort(@Query("q") query: String, @Query("begin_date") start_date: Int, @Query("sort") sort: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQueryNewsDesk(@Query("q") query: String, @Query("fq") news_desk: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQueryBeginDateNewsDesk(@Query("q") query: String, @Query("begin_date") start_date: Int, @Query("fq") news_desk: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQuerySortNewsDesk(@Query("q") query: String, @Query("sort") sort: String, @Query("fq") news_desk: String, @Query("page") page: Int): Call<NewsArticle>

    @GET("articlesearch.json?")
    fun getQueryBeginDateSortNewsDesk(@Query("q") query: String, @Query("begin_date") start_date: Int, @Query("sort") sort: String, @Query("fq") news_desk: String, @Query("page") page: Int): Call<NewsArticle>
}