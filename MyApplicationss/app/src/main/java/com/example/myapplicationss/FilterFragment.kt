...
import com.example.myapplicationss.View.MainActivity
...
class FilterFragment : DialogFragment(), View.OnClickListener {
    ...
    private fun saveFilter(){
        ...
        if ((checkbox1.isChecked)&&(checkbox2.isChecked)&&(checkbox3.isChecked)){
            news_desk_value = resources.getString(R.string.arts) + "20%" + resources.getString(R.string.fashion_style) + "20%" + resources.getString(R.string.sports)
        } else if ((checkbox1.isChecked)&&(checkbox2.isChecked)){
            news_desk_value = resources.getString(R.string.arts) + "20%" + resources.getString(R.string.fashion_style)
        } else if ((checkbox2.isChecked)&&(checkbox3.isChecked)){
            news_desk_value = resources.getString(R.string.fashion_style) + "20%" + resources.getString(R.string.sports)
